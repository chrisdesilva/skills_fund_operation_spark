import logo from "../images/logo_spark.jpeg" // add school logo to images folder and import here
...
export const faq = { // faq section
    ...
    loanRange: [
        {
            programName: "Operation Spark's Immersion Program",
            maxAmount: "$11,000",
            col: true,
            colAmount: "$4,500"
        }
...
export const schoolName = "Operation Spark"

export const schoolURL = 'https://operationspark.org' // update with url of school's website

export const skfURL = 'https://operationspark.skills.fund/' // update with Skills Fund url

export const headline = "Learn to Code at Operation Spark" // update headline as appropriate

export const leadContent = {
    header: "Your last step on the path toward changing your career",
    paragraph: `${schoolName} designs its program to provide students with a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const threeStepCardText = {
    ...
    step2: {
        ...
        text: "Operation Spark focuses exclusively on its Immersive program."
    },
    step3: `You'll be on your way to an exciting career in tech as part of ${schoolName}'s powerful network.`
}

export const netlifyFormName = 'operationspark_contact'

export const GATracking = 'UA-68312423-1'

export const hubspotFormId = "c9cac8e3-5db7-4a01-9b06-9da6ee20ee52" // create Hubspot form, get form id after publishing
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKOSIM17",
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $11,000 for tuition & $4,500 for cost of living."
