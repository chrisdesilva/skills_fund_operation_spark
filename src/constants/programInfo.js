...
export const leadContent = {
  ...
  paragraph: `${schoolName} designs its program to provide students with a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${
