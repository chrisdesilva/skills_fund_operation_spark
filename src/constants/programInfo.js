...
export const leadContent = {
	...
	paragraph: `${schoolName} designs its program to provide students with a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
...
export const programLoanInfo = [
	// update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
	{
		...
		url: 'https://my.skills.fund/application?lenderCode=SKOSIM17',
		loanInfo: {
...
export const programMaxText =
	'Choose the loan amount that works best for you. Borrow up to $11,000 for tuition & $4,500 for cost of living.';
